"""
Django settings for igazhamisch project.
...
with open(os.getenv('CONFIG_FILE', '/etc/igazhamisch/config.yaml'), 'r') as f:
...
WSGI_APPLICATION = 'igazhamisch.wsgi.application'
