"""
Django settings for manypixels project.
...
with open(os.getenv('CONFIG_FILE', '/etc/manypixels/config.yaml'), 'r') as f:
...
WSGI_APPLICATION = 'manypixels.wsgi.application'
